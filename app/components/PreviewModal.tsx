...
export function PreviewModal({ isOpen, template, onClose, onEdit }: PreviewModalProps) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const { createTemplateContent } = await import('@/lib/templates/index');
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full h-full flex flex-col bg-white shadow-2xl max-w-6xl mx-4 my-4 rounded-lg overflow-hidden">
        ...
        <div className="flex-1 bg-slate-100 overflow-hidden" ref={canvasRef} />
      </div>
    </div>
  );
}
